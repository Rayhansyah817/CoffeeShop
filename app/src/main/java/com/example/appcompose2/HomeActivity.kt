...
import com.example.appcompose2.component.homescreen.ImagePromo
import com.example.appcompose2.component.homescreen.ListMenu
import com.example.appcompose2.component.homescreen.ProductCoffee
import com.example.appcompose2.component.homescreen.Profile
import com.example.appcompose2.component.homescreen.Screen
import com.example.appcompose2.component.homescreen.SearchBar
...
fun HomePage1() {
    ...
    var selectedButton by remember { mutableStateOf("Cappuccino") }

    Profile()
    SearchBar()
    ImagePromo()
    ListMenu(selectedButton) { selectedButton = it }

    ProductCoffee(selectedButton = selectedButton)
